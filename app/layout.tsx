...
const APP_NAME = "Prozync AI";
const APP_DEFAULT_TITLE = "Prozync AI - Intelligent Autonomous AI Workspace";
const APP_TITLE_TEMPLATE = "%s | Prozync AI";
const APP_DESCRIPTION =
  "Prozync AI is an advanced AI workspace with autonomous agent execution, secure sandboxes, and developer-grade intelligence.";
...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/images/Prozync-Logo.png", sizes: "any" },
      { url: "/icon-192x192.png", sizes: "192x192", type: "image/png" },
      { url: "/icon-512x512.png", sizes: "512x512", type: "image/png" },
    ],
    shortcut: "/images/Prozync-Logo.png",
    apple: [
      { url: "/images/Prozync-Logo.png" },
