...
export const metadata: Metadata = {
  title: "Privacy Policy | Prozync AI",
  description:
    "Privacy Policy and data handling practices for Prozync AI services.",
  openGraph: {
    title: "Privacy Policy | Prozync AI",
    description:
      "Privacy Policy and data handling practices for Prozync AI services.",
    ...
    <div className="px-4 py-8 pb-16 md:px-0">
      <main className="container mx-auto max-w-2xl rounded-md border bg-card px-4 py-8 shadow-lg sm:px-8">
        ...
        <div className="mt-8 space-y-7 text-base leading-relaxed text-card-foreground sm:text-lg">
          <p>
            This Privacy Policy explains how Prozync AI (&quot;Prozync AI,&quot;
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              available browser controls and Prozync AI&apos;s Cookie settings to
          ...
          <section>
            ...
            <p>
              Prozync AI is responsible for the personal information described
