...
export const metadata: Metadata = {
  title: "Security & Trust | Prozync AI",
  description:
    "How Prozync AI handles your data: AI providers, sandbox execution, storage, billing, account security, and subprocessors.",
  openGraph: {
    title: "Security & Trust | Prozync AI",
    description:
      "How Prozync AI handles your data: AI providers, sandbox execution, storage, billing, account security, and subprocessors.",
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <header className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Prozync AI is an advanced AI workspace with autonomous agent
            execution, secure sandboxes, and developer-grade intelligence.
        ...
        <div className="space-y-6">
          <Section icon={Database} title="Data we process">
            <p>Depending on how you use Prozync AI, the service processes:</p>
            <CheckList
              items={[
