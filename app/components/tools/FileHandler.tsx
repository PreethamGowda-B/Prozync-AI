...
const FILE_APPROVAL_TITLES: Partial<Record<FileInput["action"], string>> = {
  write: "Allow Prozync AI to create this file?",
  append: "Allow Prozync AI to append to this file?",
  edit: "Allow Prozync AI to edit this file?",
};
  ...
  const renderApprovalRequest = ({
    ...
    <ToolApprovalControls
      ...
      title={
        ...
        "Allow Prozync AI to change this file?"
      }
