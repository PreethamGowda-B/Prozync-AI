...
export interface CustomizeProzyncAIDialogProps {
  open: boolean;
...
export const CustomizeProzyncAIDialog = ({
  open,
  onOpenChange,
}: CustomizeProzyncAIDialogProps) => {
        ...
        <div className="flex-1 overflow-y-auto pb-3">
          <div className="space-y-5 pb-3">
            ...
            <div className="flex flex-col gap-2 px-1">
              <Label htmlFor="nickname">What should Prozync AI call you?</Label>
              <TextareaAutosize
                id="nickname"
            ...
            <div className="flex flex-col gap-2 px-1">
              ...
              <TextareaAutosize
                id="occupation"
                placeholder="Occupation or area of focus"
                value={occupation}
            ...
            {/* Traits */}
            <div className="flex flex-col gap-2 px-1">
              <Label>What traits should Prozync AI have?</Label>
            ...
            <div className="flex flex-col gap-3 px-1">
              <Label htmlFor="additional-info">
                Anything else Prozync AI should know about you?
              </Label>
              <TextareaAutosize
                id="additional-info"
