...
export const metadata: Metadata = {
  title: "Terms of Service | Prozync AI",
  description: "Terms of Service and conditions for Prozync AI services.",
  openGraph: {
    title: "Terms of Service | Prozync AI",
    description: "Terms of Service and conditions for Prozync AI services.",
    type: "website",
        ...
        <div className="mt-4 text-lg leading-relaxed text-card-foreground">
          <ol className="list-inside list-decimal">
            ...
            <li className="mb-3">
              ...
              harmless Prozync AI, its parent companies, and their respective
            ...
            <li className="mb-3">
              <strong>Changes to Terms of Service:</strong> Prozync AI
          ...
          <p className="mt-4">
            By using the Products provided by Prozync AI, you indicate your
